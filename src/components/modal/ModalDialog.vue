...
const notInCurrentPage = computed(() => routePath.value !== route.path)
  ...
  <Teleport to="body">
    ...
    <Transition name="dialog-visible" @transitionend="trapFocusDialog">
      <div
        ...
        scrollbar-hide fixed inset-0 of-y-auto overscroll-none
      >
        ...
        <div
          class="dialog-mask"
          absolute inset-0 z-0 touch-none bg-transparent opacity-100 backdrop-blur-sm backdrop-filter
        />
        <!-- Mask layer: dimming -->
        ...
        <div class="p-safe-area" pointer-events-none absolute inset-0 z-1 flex opacity-100>
          <div flex flex-1 items-center justify-center p-4>
            ...
            <div
              ref="elDialogMain"
              class="dialog-main pointer-events-auto isolate max-h-full w-full touch-pan-x touch-pan-y of-y-auto overscroll-contain border-1px border-base rounded border-solid bg-base shadow-lg"
